...
exports.transportOptions = exports.verifiedGuides = exports.localFood = void 0;
...
function getSmartRecommendations(currentTime, crowdPreference = 'medium', category) {
    const hour = new Date(currentTime).getHours();
    // Time-based recommendations
    let recommendations = [];
    if (category === 'food' || !category) {
        if (hour >= 7 && hour < 11) {
            recommendations.push(...exports.localFood.filter(f => f.id === 'rawat-mishthan'));
        }
        else if (hour >= 12 && hour < 15) {
            recommendations.push(...exports.localFood.filter(f => f.id === 'laxmi-misthan'));
        }
        else if (hour >= 18) {
            recommendations.push(...exports.localFood.filter(f => f.id === 'chokhi-dhani'));
        }
    }
    if (category === 'guide' || !category) {
        recommendations.push(...exports.verifiedGuides);
    }
    if (category === 'transport' || !category) {
        recommendations.push(...exports.transportOptions);
    }
