...
exports.getTourismTrends = getTourismTrends;
exports.getSeasonalAnalysis = getSeasonalAnalysis;
exports.getTouristEntryPoints = getTouristEntryPoints;
function getTourismTrends(year = new Date().getFullYear()) {
...
function getTouristEntryPoints() {
    return [
